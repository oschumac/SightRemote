...
public class AppReadReminderSnooze extends CRCAppLayerMessage {

    private short blockID;
    private ReminderStatusBlock parameterBlock;
    ...
    public void readFromParcel(Parcel in) {
        ...
        if (length != 0) {
            ...
            parameterBlock = (ReminderStatusBlock) ParameterBlock.deserialize(ConfigBlocks.BLOCKS.get(blockID), byteBuf);
    ...
    protected void parseData(Pipeline pipeline, ByteBuf data) {
        ...
        parameterBlock = (ReminderStatusBlock) ParameterBlock.deserialize(ConfigBlocks.BLOCKS.get(blockID), data);
    }

    public ReminderStatusBlock getParameterBlock() {
        return parameterBlock;
    }

    public void setBlockID(ReminderStatusBlock.BlockID blockID) {
